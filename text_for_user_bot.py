timer_settings = {'how_long': 2, 'timer_is_over_text':'''Твое время вышло. Включи уведомления чтоби успеть в следующий раз...''', 'new_timer_text':'''Появилось окно оплати. Жми /start''', 'end_of_timer_text':'''Доступ к боту закроется в'''}
block_noprime = {'buttons': [('Да', 'choose_time'), ('Нет', 'menu')], 'text': '''Tи потерял доступ к каналу. Хочешь получить снова?'''}

block_start = {'edit':False, 'buttons':[('Подробносри канала', 'channel'), ('Оплата', 'choose_time'), ('Задать вопрос', 'question')], 'text':'''Приветствую 👋
