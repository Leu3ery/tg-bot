...
block_crypto = {'edit':True, 'buttons':[('В меню', 'menu')], 'text':'''Оплата по крипте пока не доступна'''}
block_lavatopusd = {'edit':True, 'buttons':[('В меню', 'menu')], 'text':'''Оплата по банковской карте пока не доступна'''}
