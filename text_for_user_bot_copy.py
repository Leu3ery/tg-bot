timer_settings = {'how_long': 20, 'timer_is_over_text': 'Твое время вышло. Включи уведомления чтоби успеть в следующий раз...', 'new_timer_text': 'Появилось окно оплати. Жми /start', 'end_of_timer_text': 'Доступ к боту закроется в'}
...
block_got_access = {'edit': True, 'buttons': [('Мои подписки', 'myPrime'), ('В меню', 'menu')], 'text': 'Ты получил доступ к каналу: '}
